...
export default function Button({
  ...
  return (
    <motion.button
      ...
      className={`group relative text-[4vw] md:text-[1.9vw] lg:text-xs xl:text-sm 2xl:text-lg inline-flex items-center justify-center rounded-full bg-foreground text-background px-5.5 py-3 lg:px-4 2xl:px-7 lg:py-1.5 xl:py-2 2xl:py-3.5 cursor-pointer overflow-hidden border border-transparent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-600 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${className}`}
      {...props}
    >
      ...
      <div className="relative z-10 flex items-center gap-3 overflow-hidden h-6">
        ...
        >
          ...
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            className="shrink-0 w-4 h-4 lg:w-3 lg:h-3 xl:w-4 xl:h-4 -mt-0.5"
          >
