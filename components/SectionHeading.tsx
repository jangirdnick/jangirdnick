...
export default function SectionHeading({
  ...
  return (
    <div className={`flex items-center gap-1 ${className}`}>
      {icon ? icon : (
        <div className="-mt-1">
          <svg className="fill-orange-600" width={16} height={16} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <div>
        <h3 className="font-helveticaMediumItalic uppercase">{title}</h3>
      </div>
    </div>
  );
}
